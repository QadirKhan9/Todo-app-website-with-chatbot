...
## Project Requirements and Agent Usage
...
### Specialized Agents
Use the following specialized agents for different aspects of the project:
...
## Active Technologies
- Python 3.11 (backend), JavaScript/TypeScript (frontend) + Next.js 16+, FastAPI, SQLModel, Better Auth, Neon PostgreSQL driver (001-todo-app-fullstack)
- Python 3.11 (backend), JavaScript/TypeScript (frontend) + Next.js 16+, FastAPI, Better Auth, python-jose, passlib (001-auth-jwt)
- N/A (stateless JWT authentication) (001-auth-jwt)
- Python 3.11 + FastAPI, OpenAI Agents SDK, SQLModel, Neon PostgreSQL driver (006-ai-chatbot)
- Python 3.11 + FastAPI, OpenAI SDK, SQLModel, Neon PostgreSQL driver (005-chat-api)

## Recent Changes
- 001-todo-app-fullstack: Added Python 3.11 (backend), JavaScript/TypeScript (frontend) + Next.js 16+, FastAPI, SQLModel, Better Auth, Neon PostgreSQL driver
